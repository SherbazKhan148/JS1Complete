...
// var a = prompt();
// if (a=="Sherbaz Khan"||a=="sherbaz khan"||a=="SHERBAZ KHAN"||a=="Sherbaz khan")
// {
//     alert("Welcome");
// }
...
// var a = prompt("Write a Character or Number");
// if(a>0 && a<65)
// {
//     alert("Its a Number");
// }
...
// var a = +prompt("Enter Time in the format: 1200\nIt means 12:00");
// if(a>=0000 && a<1200)
// {
//     alert("Good Morning");
// }
...
/* Q15. Ask the user what the current hour is. If the hour is between
...
// var a = +prompt("Enter Current Hour");
// if(a>=6 && a<=9)
// {
...
// else 
// {
//     alert("Sorry You'll Have to Wait");
// }
